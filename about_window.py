...
def show_about_window(parent):
    ...
    ttk.Label(content_frame, text="Version: 1.3").pack(anchor="w")
    ttk.Label(content_frame, text="Author: Linux Gaming Central").pack(anchor="w")
    ...
    ttk.Label(content_frame, text="Copyright (C) 2025 Linux Gaming Central").pack(anchor="w", pady=(10, 10))
